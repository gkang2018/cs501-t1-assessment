...
class UserAPI(MethodView): 
    ...
    def get(self): 
        ...
        cleaned_users = [{"id": user.id, "admin": user.admin, "email": user.email, "registered_on": user.registered_on} for user in users ]
        return make_response(jsonify(cleaned_users)), 201
